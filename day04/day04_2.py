...
def bingo():
    ...
    i = 0
    final_winner = False
    while not final_winner and i<len(random_numbers):
        ...
        if not is_prod:
            ...
            input()
        i+=1
    unmarked = sum_unmarked_numbers(boards[0])
    print(f'Score is {unmarked}*{random_numbers[i-1]}={unmarked*random_numbers[i-1]}')
